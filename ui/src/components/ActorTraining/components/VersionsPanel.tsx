...
export function VersionsPanel({ versions, onCheckStatus, onMarkAsGood, actorId }: VersionsPanelProps) {
          ...
          <div key={version.id} className={`version-card ${version.status}`}>
            ...
            <div className="version-info">
              <div className="info-row">
                <span>Dataset:</span>
                <span>{version.imageCount} images</span>
              </div>
              <div className="info-row">
                <span>Steps:</span>
              ...
              <div className="version-actions">
                ...
                {version.status === 'completed' && version.loraUrl && onMarkAsGood && actorId && (
                  <button
                    onClick={() => {
                      console.log('[VersionsPanel] Mark as Good button clicked!', { versionId: version.id, actorId });
